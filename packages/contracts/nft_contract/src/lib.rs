...
impl Contract {
    #[init]
    pub fn new(owner_id: ValidAccountId, metadata: NFTContractMetadata, mint_token: AccountId, 
        mint_cost: U128, royalties_account: AccountId, royalties_value: U128) -> Self {
...
impl Contract {
    fn only_owner(&self) {
        assert_eq!(env::predecessor_account_id(), self.tokens.owner_id, "Only owner can call this function");
    }
}
