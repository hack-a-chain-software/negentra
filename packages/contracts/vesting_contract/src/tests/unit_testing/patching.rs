...
pub fn patch_schema() -> (PatchGuard, PatchGuard, PatchGuard) {
    ...
    let new_patch = guerrilla::patch9(Schema::new, |_0, _1, _2, _3, _4, _5, _6, _7, _8| {
        Schema{
            category: _0,
    ...
    // let change_patch = 0;
    // let curve_patch = 0;
    let change_patch = guerrilla::patch9(Schema::change_schema, |_0, _1, _2, _3, _4, _5, _6, _7, _8| {
    ...
    let curve_patch = guerrilla::patch4(CurveType::calculate_curve_return, |_0, _1, _2, _3| {
        42
    });
...
pub fn patch_investment() -> (PatchGuard, PatchGuard) {
    let new_patch = guerrilla::patch3(Investment::new, |_0, _1, _2| {
        Investment{
            account: _0,
            total_value: 0,
            withdrawn_value: 0,
    ...
    let increase_withdraw_value_patch = guerrilla::patch2(Investment::increase_withdraw_value, |_0, _1| {
